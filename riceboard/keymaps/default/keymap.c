...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x5_3(
        ...
        KC_RCTL, KC_Z, KC_X, KC_C, KC_V,  KC_B, KC_N, KC_M, KC_LALT, KC_LSFT,
        LT(2, KC_NO), KC_BSPC, KC_DEL,    KC_ENT, KC_SPC, LT(1, KC_NO)
    ),
    [1] = LAYOUT_split_3x5_3(
        KC_1, KC_2, KC_3, KC_4, KC_5,                   KC_6, KC_7, KC_8, KC_9, KC_0,
        KC_EXLM, KC_AT, KC_LPRN, KC_RPRN, KC_LGUI,      KC_CIRC, KC_AMPR, KC_ASTR, KC_HASH, KC_DLR,
    ...
    [2] = LAYOUT_split_3x5_3(
        ...
        KC_RCTL, KC_NO, KC_PCMM, KC_DOT, KC_SLSH,   KC_NO, KC_NO, KC_NO, KC_LALT, KC_LSFT,
        LT(2, KC_NO), KC_BSPC, KC_DEL,              KC_ENT, KC_SPC, LT(1, KC_NO)
    ),
};
